...
Route::get('/galleries/all', [GalleryController::class, 'full'])->name('galleries.full');
...
Route::middleware('auth')->group(function () {
    ...
    Route::put('/reservations/{id}/konfirmasi', [ReservationController::class, 'konfirmasi'])->name('reservations.konfirmasi');
